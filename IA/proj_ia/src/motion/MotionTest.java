...
public class MotionTest extends Component {
	...
	static final String TERRAIN_PATH = "motion/th.png";
    ...
    public Dimension getPreferredSize() {
 	...
 	public static void main(String[] args) {		
		...
		if( n != null) {
			...
			System.out.println(n.getPath().size());
			...
			for( Object action: n.getPath()) {
				...
				//DEBUG
				//System.out.println(action + " x: "+current.getCoordX()+", y: "+current.getCoordY()+", z: "+t.getHeight(current.getCoordX(), current.getCoordY()));
			}
		}
