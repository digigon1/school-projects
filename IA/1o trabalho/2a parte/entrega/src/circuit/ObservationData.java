...
public class ObservationData {
	...
	/**
	 * 	Classe que representa o intervalo de observacao dos pontos de visita (Spots)
	 */
	public class ObservationInterval implements Comparable<ObservationInterval> {
		...
		/**
		 * 	Metodo para testar se um valor no tempo esta entre os limites do intervalo
		 * @param time
		 * @return boolean
		 */
		...
		/**
		 * 	Metodo para testar se um valor no tempo esta antes do limite superior
		 * @param time
		 * @return boolean
		 */
		...
		/**
		 * 	Metodo para testar se um valor no tempo esta depois do limite superior
		 * @param time
		 * @return boolean
		 */
		...
		/**
		 * 	Metodo que retorna os limites do tempo segundo um certo formato
		 * @return uma string
		 */
	...
	public class ObservationSpot {
		 ...
		 /**
			 ...
			 * @param obstimes conjunto de intervalos possiveis para visita
			 */
		...
		* Construtor da classe
		...
		/**
		* metodo que devolve o nome do spot (ponto de visita)
		 * @return name
		 */
		...
		/**
		* metodo que devolve o tempo de demora efectivo de visita do spot, em funcao do parametro currtime
		...
		/**
		* metodo que devolve o menor limite inferior (tempo) num conjunto de intervalos
		* @return mintime (o menor dentro do conjunto)
		...
		/**
		* metodo que devolve uma string com o nome, as coordenadas e a duracao da visita a um spot
	...
	* @parm s, uma string com um formato previsto
	...
	/**
	* Metodo que retorna o numero de spots
	* @return size, o numero de spots que e necessario visitar
	 */
	public int getSize() {
		return size;
	}
	/**
	* Metodo que retorna o spot indicado em parametro
	* @parm i, o indice para aceder ao spot
	* @return spots[i], um spot especifico
	 */
	public ObservationSpot getSpot(int i) {
		return spots[i];
	}
	/**
	* Metodo que retorna o custo entre os spots i e j
