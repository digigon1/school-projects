...
test_folder = 'models/2020-02-06T23:07:13.661247'
# test_folder = None

# prev_model = 'models/2020-02-06T23:07:13.661247/weights.047-0.26445.hdf5'
prev_model = None
...
split_point = int(len(X_array[0]) * 0.87) # Memory limited to 0.87 instead of usual 0.8
...
if test_folder is not None:
	...
	print('===== Fitting =====')
	model.fit_generator(seq, initial_epoch=done_epochs, epochs=epochs, use_multiprocessing=True, verbose=1, callbacks=[checkpoint_callback])
