...
test_folder = 'models/2020-02-05T04:59:22.121858'
# test_folder = None

# prev_model = 'models/2020-02-05T04:59:22.121858/weights.056-0.11912.hdf5'
prev_model = None
...
seq = CustomSequence(X_array, Y_array, time_window, batch_size=int(len(X_array[0]) / 200)) # Fixed ~(200 * 5) iterations
...
model.add(CuDNNGRU(units=256, input_shape=(time_window + 1, feature_count), return_sequences=False))
