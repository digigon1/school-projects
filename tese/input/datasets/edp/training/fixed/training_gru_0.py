...
# prev_model = 'models/2019-08-16T17:03:55.368091/weights.100-0.47007.hdf5'
prev_model = None
...
class CustomSequence(Sequence):
	...
	def __getitem__(self, idx):
		...
		weights[:] = 1.
		weights[np.unique(np.where(Y_batch > 0)[0])] = 50.
...
if prev_model is not None:
	...
	model.fit_generator(seq, epochs=epochs, use_multiprocessing=False, verbose=1, callbacks=[checkpoint_callback])
