...
# prev_model = 'models/2020-01-30T15:14:29.597006/weights.004-0.24684.hdf5'
prev_model = None
...
model.add(CuDNNLSTM(units=256, input_shape=(time_window + 1, feature_count), return_sequences=True))
